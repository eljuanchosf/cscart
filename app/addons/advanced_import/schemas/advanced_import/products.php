    ...
    'options'             => array(
        'images_delimiter' => array(
            ...
            'option_data_post_modifier' => function ($option, $preset) {
                if (isset($preset['file'])) {
                    $ext = pathinfo($preset['file'], PATHINFO_EXTENSION);
        ...
        'images_path'      => array(
            'option_data_post_modifier' => function ($option, $preset) {
                $option['option_template'] = 'addons/advanced_import/views/import_presets/components/options/images_path.tpl';
