 ...
 * @param string       $remove_images    Wheter to remove additional images
 */
function fn_advanced_import_set_product_images($product_id, $images, $images_path, $images_delimiter, $remove_images)
{
    ...
    foreach ($images as $i => $image) {
        ...
        fn_exim_import_images(
            ...
            $product_id,
            'product',
            array('remove_images' => $remove_images)
        );
    }
}
