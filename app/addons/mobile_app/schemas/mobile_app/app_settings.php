                ...
                'resolutions' => array(
                    'landscape' => array(
                        array(
                            ...
                            'height' => 1242,
                            'name'   => 'Default-1242@3x~iphone6s-landscape_2208x1242',
                        ),
                        array(
                            'width'  => 1334,
                            'height' => 750,
                            'name'   => 'Default-750@2x~iphone6-landscape_1334x750',
                        ),
                        array(
                            'width'  => 2048,
                            'height' => 1496,
                            'name'   => 'Default-Landscape@2x~ipad_2048x1496',
                        ),
                        array(
                            'width'  => 2048,
                            'height' => 1536,
                            'name'   => 'Default-Landscape@2x~ipad_2048x1536',
                        ),
                        array(
                            'width'  => 1024,
                            'height' => 748,
                            'name'   => 'Default-Landscape~ipad_1024x748',
                        ),
                        array(
                            'width'  => 1024,
                            'height' => 768,
                            'name'   => 'Default-Landscape~ipad_1024x768',
                        ),
                    ),
                    'portrait'  => array(
                        array(
                            ...
                            'name'   => 'Default-1242@3x~iphone6s-portrait_1242x2208',
                        ),
                        array(
                            'width'  => 750,
                            'height' => 1334,
                            'name'   => 'Default-750@2x~iphone6-portrait_750x1334',
                        ),
                        array(
                            'width'  => 1536,
                            'height' => 2008,
                            'name'   => 'Default-Portrait@2x~ipad_1536x2008',
                        ),
                        array(
                            'width'  => 1536,
                            'height' => 2048,
                            'name'   => 'Default-Portrait@2x~ipad_1536x2048',
                        ),
                        array(
                            'width'  => 768,
                            'height' => 1024,
                            'name'   => 'Default-Portrait~ipad_768x1024',
                        ),
                        array(
                            'width'  => 768,
                            'height' => 1004,
                        ...
                        array(
                            'width'  => 640,
                            'height' => 960,
                            'name'   => 'Default@2x~iphone_640x960',
                        ),
                        array(
                            'width'  => 1536,
                            'height' => 2008,
                        ...
                        array(
                            'width'  => 640,
                            'height' => 1136,
                            'name'   => 'Default-568h@2x~iphone_640x1136',
                        ),
                    ),
                ),
            ),
