...
class Sender
{
     ...
     * Sender constructor.
     *
     * @param array      $addon_settinsg `Mobile app` add-on settings
     * @param \Tygh\Http $http           Netwowrk requestor
     */
    public function __construct(array $addon_settinsg, Http $http)
    {
        $this->addon_settings = $addon_settinsg;
        $this->http = $http;
    }
    ...
    protected function getHeaders()
    {
        return array(
            ...
            'Authorization: key=' . $this->addon_settings['fcm_api_key'],
        );
    }
    ...
    {
        return !empty($this->addon_settings['fcm_api_key']);
    }
}