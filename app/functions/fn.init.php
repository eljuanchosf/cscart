...
function fn_check_cache($params)
{
    ...
    $core_hashes = array(
        '020ae39aae274f2786e44e1f3901d0930c8e4f99' => array(
...
{
    $fn_prepare_request = function ($data) use (&$fn_prepare_request) {
        ...
        foreach ($data as $key => $value) {
            if (preg_match("/(.+\b{$prefix}\w+|.+\?:\w+|;.+)/", $key)) {
                ...
                $data[$key] = $fn_prepare_request($value);
            }
        }
