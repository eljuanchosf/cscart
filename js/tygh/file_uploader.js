    ...
    $.extend(FileUploader.prototype, {
                ...
                if (addedFile.mock) {
                    ...
                    if (addedFile.mock.type === 'existing') {
                        if (addedFile.mock.existingPair) {
                            addedFile.previewLink = addedFile.mock.existingPair.detailed.image_path;
                            ...
                            addedFile.dynamicData['alt-text-detailed'] = {
                                name: 'detailed_alt',
                                value: addedFile.mock.existingPair.detailed.alt,
                                defaultValue: addedFile.mock.existingPair.detailed.alt,
                                postfix: '_data'
                            };
                            addedFile.dynamicData['is-new-file'] = {
                                name: 'is_new',
        ...
        registerExistingFiles: function () {
            ...
            $.each(this.options.existingFiles, function () {
                ...
                if (this.detailed_id && this.detailed) {
                    var mockFile = {
                        name: null,
                        size: null,
                        mock: {
